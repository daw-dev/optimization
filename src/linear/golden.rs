...
impl Optimizer<f64, f64, Range<f64>, Result<Range<f64>, String>> for GoldenRatio<Precision> {
...
impl Optimizer<f64, f64, Range<f64>, Result<Range<f64>, String>> for GoldenRatio<Iterations> {
    fn optimize<F: Function<f64, f64>>(
        self,
        func: &F,
        starting_guess: Range<f64>,
